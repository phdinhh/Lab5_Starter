...
2. I would use a unit test to test the "max message length" feature because this is a smaller scale feature that we could easily test if we encounter bugs. Moreover, this feature is not something that requires interactions between other components on an application level. Therefore, a unit test is good to test this feature.
